...
class ORoomController extends BaseController
{
    private $room = '' ;
    private $flat = null ;
    ...
    public function save(){
        ...
        return $this->response->redirect(site_url('/oroom'));
    }
