...
class OFlatController extends BaseController
{
    private $flat = '' ;
    ...
    //    dd($data);
        ...
        return view('owner/fcreate',$data);
    }

     public function edit($id){
         $data['flat']=$this->flat->find($id);
         $data['property']=$this->property->findAll();
         return view('owner/fedit',$data);
     }
    ...
    public function save(){
        ...
        return $this->response->redirect(site_url('/oflat'));
    }
