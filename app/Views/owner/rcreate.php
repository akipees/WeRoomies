...
<form method="post" action="<?php echo site_url('/oadd-room'); ?>">

<div class="modal-header">
        <h4 class="modal-title text-centre"><b>Create Room</b></h4>
</div>

<div class="modal-body">
    <div class="form-group">
        <label>pmtid</label>
        <input type="number" name="pmt_id" id="pmt_id" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Flat_id</label>
        <input type="number" name="Flat_id" id="Flat_id" class="form-control" required>
    </div>
    <div class="form-group">
        <label>Hot Water Service</label>
        <input type="text" name="HotWater_Service" id="HotWater_Service" class="form-control" required>
    </div>
    <div class="form-group">
        <label>RO Water Service</label>
        <input type="text" name="ROWater_Service" id="ROWater_Service" class="form-control" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="number" name="Capacity_of_peoples" id="Capacity_of_peoples" class="form-control" required>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <input type="text" name="RoomAllocation" id="RoomAllocation" class="form-control" required>
    </div>
    <div class="form-group">
