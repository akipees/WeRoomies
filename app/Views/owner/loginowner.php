        ...
        <div class="row no-gutters">
          ...
          <div class="col-md-7">
            <div class="card-body">
              ...
              <form action="<?= base_url('/ownerlogin')?>" method='post'>
              ...
              <p class="login-card-footer-text">Don't have an account? <a href="/oregistration" class="text-reset">Register here</a></p>
            </div>
          </div>
        </div>
      </div>
