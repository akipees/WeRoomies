...
<header class="site-navbar" role="banner">
      <div class="container" >
        ...
        <div class="col-11 col-xl-2">
            <h4 class="mb-0 site-logo"><b><a href="index.html" class="text-white mb-0">WeRoomies</a></b></h4>
          </div>
          <div class="col-12 col-md-10 d-none d-xl-block">
            <nav class="site-navigation position-relative text-right" role="navigation">
              <ul class="site-menu js-clone-nav mr-auto d-none d-lg-block">
                <li class="active"><a href="/ahome"><span>Home</span></a></li>
                <li><a href="/oflat"><span>Flat</span></a></li>
                <li><a href="/oroom"><span>Room</span></a></li>
          ...
          <div class="col-md-6 col-sm-6">
            ...
            <div class="footer-pad">
              ...
              <ul class="list-unstyled">
                <li><a href="#"></a></li>
                <li><a href="/oroom">Room</a></li>
                <li><a href="/oflat">Flat</a></li>
              </ul>
            </div>
          </div>
          <div class="col-md-6 col-sm-6">
