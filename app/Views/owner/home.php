    ...
    <div class="container-xxl py-5 wow fadeInUp" data-wow-delay="0.1s">
        <div class="container text-center">
            <div class="row justify-content-center">
                ...
                <h5 class="abc">Why WeRoomies</h5>
                    <h2 class="display-1"><b>Welcome Owner!</b></h2>
                    <h5 class="mb-4">You can add Rooms and Flats here</h5>
                    <p class="mb-4">Maintaining a profile can be very tough.
                        We have made this section to help you maintain the room and flat sections.
                        You can Handle the CRUD Applications, 
                        i.e. insert, edit and delete data from the database for flats and rooms from here. 
                    </p>
                </div>
            </div>
        </div>
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6 wow fadeInUp" data-wow-delay="0.3s" style="margin-top:50px;">
                ...
                <div class="row" style="animation:fadeInAnimation ease 3s;animation-iteration-count:1;animation-fill-mode:forwards;">
                    ...
                    <div class="col-sm-6">
                        <p class="mb-0"><i class="fa fa-arrow-right me-2"></i> In Rooms And Flats</p>
                    </div>
                </div>
