          ...
          <div class="col-md-7">
            <div class="card-body">
              <span class="brand-wrapper">
                <img src="./project.png" alt="logo" class="logo">
              </span>
              ...
              <p class="login-card-footer-text">Don't have an account? <a href="/pages/registration" class="text-reset">Register here</a></p>
